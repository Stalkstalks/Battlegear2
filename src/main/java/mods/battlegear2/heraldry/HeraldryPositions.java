...
public enum HeraldryPositions {
    ...
    FOUR(
            4,
            new float[] {-1.25F, -1.25F, -1.25F, -1.25F},
    ...
    private HeraldryPositions(
            int passess, float[] sourceX, float[] sourceY, float width, boolean[] patternFlip, boolean[] altColours) {
