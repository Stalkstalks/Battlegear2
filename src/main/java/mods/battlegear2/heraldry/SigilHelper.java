...
public class SigilHelper {
    ...
    public static Color getPrimaryColour(byte[] code) {
        return new Color((code[1] >> 4 & 0x0F) * 16, (code[1] & 0x0F) * 16, (code[2] >> 4 & 0x0F) * 16);
    }
    ...
    public static Color getSecondaryColour(byte[] code) {
        return new Color((code[2] & 0x0F) * 16, (code[3] >> 4 & 0x0F) * 16, (code[3] & 0x0F) * 16);
    }
    ...
    public static Color getSigilPrimaryColour(byte[] code) {
        return new Color((code[5] >> 4 & 0x0F) * 16, (code[5] & 0x0F) * 16, (code[6] >> 4 & 0x0F) * 16);
    }
    ...
    public static Color getSigilSecondaryColour(byte[] code) {
        return new Color((code[6] & 0x0F) * 16, (code[7] >> 4 & 0x0F) * 16, (code[7] & 0x0F) * 16);
    }
