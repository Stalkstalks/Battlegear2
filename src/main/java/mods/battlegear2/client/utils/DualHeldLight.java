...
/**
 * Created by GotoLink on 06/06/2014. Using DynamicLight interface to give player a chance of light when holding offhand
 * item
 */
public final class DualHeldLight implements IDynamicLightSource {
    ...
    public boolean equals(Object object) {
        ...
        if (object instanceof IDynamicLightSource) return ((IDynamicLightSource) object).getLightLevel() == this.light
                && ((IDynamicLightSource) object).getAttachmentEntity().getEntityId() == this.dual.getEntityId();
        return false;
    }
