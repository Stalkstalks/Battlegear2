...
public final class BattlegearConfigGUI extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.possibleValues = new GUITextList(
        ...
        this.buttonList.add(new GuiToggleButton(
                2,
                this.width / 2 - 180,
                this.height / 2 - 100,
        ...
        this.buttonList.add(new GuiToggleButton(
                ...
                this.width / 2 - 180,
                this.height / 2 - 70,
                I18n.format("render.quiver.skeleton") + ":" + BattlegearConfig.enableSkeletonQuiver,
                this.fontRendererObj));
        this.buttonList.add(new GuiToggleButton(
                5,
                this.width / 2 + 20,
                this.height / 2 - 70,
                I18n.format("render.arrow.bow") + ":" + BattlegearConfig.arrowForceRendered,
                this.fontRendererObj));
        this.buttonList.add(new GuiToggleButton(
                6,
                this.width / 2 - 180,
        ...
        this.buttonList.add(new GuiToggleButton(
                ...
                this.width / 2 + 20,
                this.height / 2 + 60,
                I18n.format("render.hud.forced") + ":" + BattlegearConfig.forceHUD,
                this.fontRendererObj));
        this.possibleValues.registerScrollButtons(this.buttonList, 8, 9);
        this.buttonList.add(
                new GuiButton(10, this.width / 2 - 180, this.height / 2 + 60, I18n.format("gui.open.fake")));
        this.buttonList.add(new GuiToggleButton(
                11,
                this.width / 2 + 60,
                this.height / 2 - 40,
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        this.drawCenteredString(
                this.fontRendererObj,
                I18n.format("config.battlegear.title"),
                this.width / 2,
                this.height / 2 - 115,
                0xFFFFFF);
        this.drawCenteredString(
                this.fontRendererObj,
                I18n.format("config.battlegear.category"),
                this.width / 2,
                this.height / 2 - 15,
                0xFFFFFF);
        this.fontRendererObj.drawSplitString(
                I18n.format("config.battlegear.warn"),
                this.width / 2 + 60,
                this.height / 2 + 20,
                this.width / 2 - 60,
                0xFFFFFF);
