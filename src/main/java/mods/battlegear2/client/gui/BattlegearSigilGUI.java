...
public class BattlegearSigilGUI extends GuiContainer {
    ...
    public void initGui() {
        ...
        colourPickerPattern = new GuiColourPicker(
                COL_SELECT_PAT,
                (width + 200) / 2,
                45,
                0xFF000000,
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        if (elementList != null) this.elementList.drawScreen(par1, par2, par3);
    ...
    public void markAllDirty() {
        for (int i = 0; i < HeraldryData.MAX_CRESTS + 1; i++) elementList.markDirty(i);
