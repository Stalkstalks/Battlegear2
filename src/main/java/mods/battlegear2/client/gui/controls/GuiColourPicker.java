        ...
        if (visible) {
            ...
            if (isSwitchOn(ALPHA_SELECTION)) {
                ...
                this.drawGradientRect(
                        ...
                        alpha_start_x + 12,
                        sb_start_y + 48,
                        selectedRGB | 0xFF000000,
                        selectedRGB & 0x00FFFFFF);
            }
            ...
            drawRect2(
                    sb_start_x,
                    sb_start_y + (int) ((1 - selectedHSB[1]) * 48),
                    sb_start_x + 48,
                    sb_start_y + (int) ((1 - selectedHSB[1]) * 48) + 1,
                    0xFFFFFFFF);

            // Brightness Line (Vertical)
            drawRect2(
                    sb_start_x + (int) ((selectedHSB[2]) * 48),
                    sb_start_y,
                    sb_start_x + (int) ((selectedHSB[2]) * 48) + 1,
                    sb_start_y + 48,
                    0xFFFFFFFF);
            ...
            drawRect2(
                    hue_start_x,
                    sb_start_y + (int) (selectedHSB[0] * 48),
                    hue_start_x + 12,
                    sb_start_y + (int) (selectedHSB[0] * 48) + 1,
                    0xFFFFFFFF);
            ...
            if (isSwitchOn(ALPHA_SELECTION)) {
                drawRect2(
                        alpha_start_x,
                        sb_start_y + (int) ((1 - selected_alpha) * 48),
                        alpha_start_x + 12,
                        sb_start_y + (int) ((1 - selected_alpha) * 48) + 1,
                        0xFFFFFFFF);
            }
