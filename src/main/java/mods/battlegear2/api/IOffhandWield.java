...
/**
 * Created by GotoLink on 27/09/2014. To be implemented by items wishing to have select offhand wielding
 */
public interface IOffhandWield {

    /**
     * Returns true if this item can be added to the offhand slots (thus wield in left hand) Note the compatibility will
     * be determined externally against the mainhand item (in right hand), if any.
     *
