...
public interface ISpecialBow {
    ...
    /**
     * Allows a bow to define the order and contents of the {@link IArrowFireHandler} list used when getting an arrow
     * type with {@link QuiverArrowRegistry#getArrowType}, which is used by the default quiver. Other
     * {@link IArrowContainer2 quiver} implementations may or may not call this method at their discretion.
     *
     ...
     * @return A list of fire handlers to be used by {@link QuiverArrowRegistry#getArrowType} to be iterated through in
     *         the order of entry (FIFO) Returning null will cause the default fire handlers to be used. Returning an
     *         empty list will prevent any fire handlers from processing, effectively rendering the bow useless.
     */
     ...
     * @return Result.DEFAULT to use generic nocking behavior from BG2; Result.DENY to prevent the bow from being
     *         nocked; Result.ALLOW to allow the bow to be nocked, ignoring the default BG2 nocking behavior.
     */
