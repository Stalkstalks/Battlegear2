...
/**
 * Created by GotoLink on 01/05/2014. Event posted on {@link MinecraftForge.EVENT_BUS} from the player inventory
 * {@link InventoryPlayerBattle#readFromNBT(NBTTagList)} if the slot number is outside the expected boundaries
 */
