...
public class EntityPiercingArrow extends AbstractMBArrow {
    ...
    public boolean onHitEntity(Entity entityHit, DamageSource source, float ammount) {
        ...
        if (!worldObj.isRemote && entityHit instanceof IShearable) {
            if (((IShearable) entityHit)
                    .isShearable(null, worldObj, (int) entityHit.posX, (int) entityHit.posY, (int) entityHit.posZ)) {
                ArrayList<ItemStack> drops = ((IShearable) entityHit)
                        .onSheared(null, worldObj, (int) entityHit.posX, (int) entityHit.posY, (int) entityHit.posZ, 1);
